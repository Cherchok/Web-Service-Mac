...
class TableFrame extends JFrame {
    ...
    TableFrame(String title) {
        ...
        for (String leng : columnLeng) {
            ...
            if (length > table.getColumnModel().getColumn(columnNumber).getWidth()) {
                ...
                table.getColumnModel().getColumn(columnNumber).setMinWidth(table.getColumnModel().getColumn(columnNumber).getWidth());
            columnNumber++;
        }
    ...
    //get Map with name of fields as key and List of values as val.
